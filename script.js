$(document).ready(function () {
  ...
  $(".filter__item").on("click", function () {
    ...
    $(".all-objects-js").on("click", function () {
      setTimeout(function () {
        $(".link-js").attr(
          "href",
          $(".object__type.show .swiper-slide-active .hidden-link").data(
            "value"
          )
        );
      }, 500);
  ...
  var linkOnLoad = $(
    ".object__type.show .swiper-slide-active .hidden-link"
  ).data("value");
  ...
  $(".swiper-button-prev, .swiper-button-next").on("click", function () {
    $(".link-js").attr(
      "href",
      $(".object__type.show .swiper-slide-active .hidden-link").data("value")
    );
  });
  ...
  $(".all-ducumentation").addClass("show"),
    $(".all-ducumentation-js").on("click", function () {
      $(".muras-ducumentation, .jetigen-ducumentation").removeClass("show"),
        $(".muras-ducumentation, .jetigen-ducumentation").css(
          "display",
          "none"
        ),
  ...
  $("form input").on("keyup", function () {
    if (
      $(this).parents("form").find(".name-js").val() != "" &&
      $(this).parents("form").find(".phone-js").val() != ""
    ) {
  ...
  $(document).mouseup(function (e) {
    var div = $(
      ".apartment-filter__wrap, .fancybox-container, .form--application"
    );
    if (!div.is(e.target) && div.has(e.target).length === 0) {
  ...
  $(".all-obj-js").on("click", function () {
    ...
    if (
      $(".select-room .selected").text() === "1 комнатная" &&
      $(".select-condition .selected").text() === "На стадии строительства"
    ) {
      ...
      $(".select-room .selected").text() === "1 комнатная" &&
      $(".select-condition .selected").text() === "На стадии завершения"
    ) {
      ...
      $(".select-room .selected").text() === "1 комнатная" &&
      $(".select-condition .selected").text() === "Завершен"
    ) {
  ...
  $(".one-room-js").on("click", function () {
    $(".apartment-filter__item").removeClass("show");
    if (
      $(".select-obj .selected").text() === "Все" &&
      $(".select-condition .selected").text() === "На стадии строительства"
    ) {
      $(".one-room.stage-building").addClass("show");
    } else if (
      $(".select-obj .selected").text() === "ЖД «Мурас»" &&
      $(".select-condition .selected").text() === "На стадии строительства"
    ) {
      $(".one-room.muras-obj.stage-building").addClass("show");
    } else if (
      $(".select-obj .selected").text() === "ЖД «Жетиген»" &&
      $(".select-condition .selected").text() === "На стадии строительства"
    ) {
      $(".one-room.jetigen-obj.stage-building").addClass("show");
    } else if (
  ...
  $(".btn-application-js").on("click", function () {
    ...
    let roomCount = $(this)
      .parent()
      .find(".apartment-filter__item-count")
      .attr("data-count");
    let square = $(this)
      .parent()
      .find(".apartment-filter__item-square")
      .attr("data-square");
    let object = $(this)
      .parent()
      .find(".apartment-filter__item-object")
      .attr("data-object");
    let status = $(this)
      .parent()
      .find(".apartment-filter__item-status")
      .attr("data-status");

    $(
      `<div class="form-fields"><input type="hidden" name="Кол-во комнат" vaue="${roomCount}"/><input type="hidden" name="Площадь кв." vaue="${square}"/><input type="hidden" name="Жилой комплекс" vaue="${object}"/><input type="hidden" name="Статус комплекса" vaue="${status}"/></div>`
    ).prependTo(".form--application form");
  });
